export declare const ZH_CN: {
  ...
  PIC_GDRIVE_CONFIG_COPY_LINK_DIRECT: string
  // Message Keys
  ...
  PIC_GDRIVE_CONFIG_COPY_LINK_DIRECT_MESSAGE: string
  // GUI Menu Keys
...
export const localesZhCn = {
  ...
  PIC_GDRIVE_CONFIG_IMAGE_NAME_PREFIX_MESSAGE: '比如 xxx_',
  PIC_GDRIVE_CONFIG_APPEND_GOOGLE_USER_INFO: '文件名是否追加 Google 用户信息',
  PIC_GDRIVE_CONFIG_APPEND_GOOGLE_USER_INFO_MESSAGE:
    '文件名是否追加 Google 用户信息',
  PIC_GDRIVE_CONFIG_COPY_LINK_DIRECT: '是否直接复制链接到剪贴板',
  PIC_GDRIVE_CONFIG_COPY_LINK_DIRECT_MESSAGE: '如果激活,直接复制链接到剪贴板,跳过 PicGo 内建的机制',
...
export const localeEn = {
  ...
  PIC_GDRIVE_CONFIG_APPEND_GOOGLE_USER_INFO_MESSAGE:
    'File Name Append Google User Info',
  PIC_GDRIVE_CONFIG_COPY_LINK_DIRECT: 'Copy link to clipboard directly',
  PIC_GDRIVE_CONFIG_COPY_LINK_DIRECT_MESSAGE: 'If enable, copy link to clipboard directly without using the picgo build-in',
